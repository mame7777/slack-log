...
class Insert:
    ...
    def channel(self, channel_dict: dict) -> None:
        ...
        for channel_id in channel_dict.keys():
            ...
            data_channel = (channel_id, channel_name, channel_topic, channel_purpose)
    ...
    def conversation(self, conversation_dict: dict) -> None:
        ...
        for channel_conversation in conversation_dict.keys():
            ...
            for ts in conversation_dict[channel_conversation].keys():
                ...
                reply_count = int(conversation_dict[channel_conversation][ts]["reply_count"])
                # query_conversation = """INSERT INTO %s_conversation 
                #                    (ts, user_id, text, reply_count) 
                #                    VALUES (%f, %s, %s, %d)""" % (table_conversation, ts_float, user_id, text, reply_count)
